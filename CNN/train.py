...
def train(net, train_loader, val_loader, test_loader, logger):
    ...
    for i in range(cfg['epochs']):
        ...
        if i % cfg['val_every'] == 0:
            ...
            loss, acc = run(net, i, val_loader, optimizer, criterion, logger, scheduler, train=False)
            log_text = "Epoch: %d, Validation Accuracy:%2f" % (i, acc*100.0)
...
if __name__ == '__main__':
    ...
    #Run the training!
    train(net, train_loader, val_loader, test_loader, writer)
